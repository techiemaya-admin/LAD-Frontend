 ...
 * 
 * Hooks for managing conversation state and interactions.
 */

import { useState, useMemo, useCallback } from 'react';
import { Conversation, Channel, Message, UseConversationsReturn } from './types';
import { mockConversations } from '@/data/mockConversations';

/**
 * Hook to manage conversations state
 * 
 * Provides:
