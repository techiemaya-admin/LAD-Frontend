    ...
    <Box sx={{ width: '100%', p: 2 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap', position: 'relative' }}>
          ...
          <Fade in={showAITrigger}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, ml: 'auto' }}>
              ...
              >
                Start Intelligent Calling ({selectedCompanies.size})
              </Button>
            </Box>
          </Fade>
        </Box>
      ...
      <Grid container spacing={3} sx={{ position: 'relative', zIndex: 2 }}>
        {[...getFilteredData()]
          ...
          .map((company, index) => (
          <Grid item xs={12} sm={6} md={3} lg={3} xl={3} key={company.id || index} sx={{ mb: 3 }}>
            <Card 
        ...
        <Box sx={{ p: 2 }}>
          ...
          <Grid container spacing={2}>
            ...
            {employeeData
              ...
              return (
                <Grid item xs={12} sm={6} md={3} lg={3} xl={3} key={employeeId}>
                  <Card 
                    onClick={() => {
                      if (onEmployeeSelectionChange) {
