/**
 * @deprecated Import from '@/features/campaigns' instead
 * This file is kept for backward compatibility
 */
export {  campaignService as default,
  type StepType,
  type CampaignStatus,
  type LeadStatus,
  type ActivityStatus,
...
import campaignServiceSDK from '@/features/campaigns';
export const campaignService = campaignServiceSDK;
