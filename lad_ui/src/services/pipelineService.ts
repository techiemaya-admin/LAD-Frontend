/**
 * @deprecated Import from '@/features/pipeline' instead
...
import pipelineServiceSDK from '@/features/pipeline';
export const pipelineService = pipelineServiceSDK;

// Old commented code removed - now uses frontend SDK
// import api from './api';
...
//       stageData.display_order = newOrder;
//     } else {
...
//     stageData.display_order = maxOrder + 1;
//   }
