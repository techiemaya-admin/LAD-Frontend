...
export default function StepSettings() {
  ...
  const renderRequiredIndicator = (field: string) => {
    ...
    return (
      <Badge
        variant={isValidField ? 'success' : 'destructive'}
    ...
    <TooltipProvider>
      ...
      {(stepType === 'linkedin_connect' || stepType === 'linkedin_message') && (
        <>
          ...
          <div className="mb-4">
            <Label htmlFor="linkedin-message">{stepType === 'linkedin_connect' ? 'Message (Optional)' : 'Message'}</Label>
            <div className="flex items-start gap-2">
              ...
              />
              {stepType === 'linkedin_message' && renderRequiredIndicator('message')}
            </div>
