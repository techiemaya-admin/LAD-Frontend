...
export const deleteStageAction = (stageKey: string): AppThunk => async (dispatch) => {
  try {
    console.log('[Redux] deleteStageAction called with stageKey:', stageKey);
    console.log('[Redux] Calling pipelineService.deleteStage...');
    ...
    console.log('[Redux] removeStage dispatched, stage deleted successfully:', stageKey);
