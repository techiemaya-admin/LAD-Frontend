  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-white/50 max-w-[calc(100vw-2rem)] text-neutral-600 dark:text-gray-400",
...
export const MobileNavHeader = ({
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-row items-center justify-between text-neutral-600 dark:text-gray-400",
        className,
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-white px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,48,55,0.05),_0_1px_0_rgba(255,255,255,0.1) inset] dark:bg-neutral-950 text-neutral-600 dark:text-gray-400",
            className,
          )}
        >
          {children}
