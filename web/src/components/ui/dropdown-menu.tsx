...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-primary/95 focus:text-primary-foreground data-[state=open]:bg-primary/95 data-[state=open]:text-primary-foreground dark:focus:bg-[#2563eb] dark:focus:text-white dark:data-[state=open]:bg-[#2563eb] dark:data-[state=open]:text-white",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, sideOffset = 4, avoidCollisions = true, ...props }, ref) => (
    ...
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        ...
        >
          <path
            fillRule="evenodd"
            d="M20.285 6.709a1 1 0 010 1.414l-9 9a1 1 0 01-1.414 0l-5-5a1 1 0 111.414-1.414L10 14.586l8.879-8.877a1 1 0 011.406 0z"
            clipRule="evenodd"
          />
        </svg>
      </DropdownMenuPrimitive.ItemIndicator>
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-[#1c2c4e]", className)}
    {...props}
  />
))
