...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center gap-4 px-4 py-4 sm:px-8 sm:py-6 border-b border-gray-100 dark:border-[#262831] bg-white dark:bg-[#0d1b3e] shrink-0 sm:text-left", className)}
      {...props}
    />
  )
}
