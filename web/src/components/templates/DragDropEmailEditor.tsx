...
function VariablePicker({ onInsert, dropAlign = 'left' }: { onInsert: (v: string) => void; dropAlign?: 'left' | 'right' }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className={`absolute ${dropAlign === 'right' ? 'right-0' : 'left-0'} top-full mt-1.5 z-50 bg-white dark:bg-[#000c3b] rounded-xl shadow-lg border border-gray-100 dark:border-blue-950/40 py-1.5 min-w-[180px]`}>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <div className="flex items-center gap-2">
            <input type="color" value={local.bgColor || '#f3f4f6'} onChange={(e) => set('bgColor', e.target.value)} className="h-8 w-10 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer flex-shrink-0" />
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input type="color" value={local.textColor || '#6b7280'} onChange={(e) => set('textColor', e.target.value)} className="h-8 w-10 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer flex-shrink-0" />
    ...
    <>
      ...
      <div>
        ...
        <button type="button" onClick={() => fileRef.current?.click()} disabled={uploading}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 mb-2 border-2 border-dashed border-blue-200 rounded-xl text-sm text-blue-600 dark:border-blue-950/40 bg-white dark:bg-[#000724] hover:bg-blue-50 hover:border-blue-400 transition-all disabled:opacity-60">
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input type="color" value={local.accentColor || '#0b1957'} onChange={(e) => set('accentColor', e.target.value)} className="h-8 w-10 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer flex-shrink-0" />
  ...
  return (
    <>
      ...
      <div>
        ...
        {/* Divider */}
        <div className="flex items-center gap-2 my-2">
          <div className="flex-1 border-t border-gray-200 dark:border-blue-950/40" />
      ...
      {/* Image preview */}
      {local.src && (
        <div className="relative rounded-xl overflow-hidden border border-gray-200 dark:border-blue-950/40 bg-white dark:bg-[#000724]">
          <img
            src={local.src}
...
function RichTextEditor({
  ...
  return (
    <div className="border border-gray-200 dark:border-blue-950/40 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-400 transition-shadow">

      {/* ── Toolbar ── */}
      <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 bg-gray-50 dark:bg-[#000724] border-b border-gray-200 dark:border-blue-950/40">
        ...
        <select
          ...
          className="text-xs border border-gray-200 dark:border-blue-950/40 rounded px-1 py-1 bg-white dark:bg-[#000c3b] text-gray-600 dark:text-slate-300 focus:outline-none cursor-pointer"
          defaultValue=""
        >
        ...
        <select
          ...
          className="text-xs border border-gray-200 dark:border-blue-950/40 rounded px-1 py-1 bg-white dark:bg-[#000c3b] text-gray-600 dark:text-slate-300 focus:outline-none cursor-pointer max-w-[90px]"
          defaultValue=""
        >
        ...
        >
          ...
          />
          <span
            className="w-3 h-2 rounded-sm border border-gray-300 dark:border-blue-950/40 ml-0.5"
...
function BlockEditor({
  ...
  const inputCls = 'w-full text-sm px-3 py-2 border border-gray-200 dark:border-blue-950/40 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-[#000c3b] text-gray-900 dark:text-white placeholder-gray-400';
    ...
    <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/60 rounded-xl p-4 mt-2 space-y-3">
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className={labelCls}>Background</label>
              <div className="flex items-center gap-2">
                <input type="color" value={local.bgColor || '#0b1957'} onChange={(e) => set('bgColor', e.target.value)} className="h-8 w-12 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer" />
            ...
            <div>
              <label className={labelCls}>Text Color</label>
              <div className="flex items-center gap-2">
                <input type="color" value={local.textColor || '#ffffff'} onChange={(e) => set('textColor', e.target.value)} className="h-8 w-12 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer" />
      ...
      {block.type === 'divider' && (
        <div>
          ...
          <div className="flex items-center gap-2">
            <input type="color" value={local.color || '#e5e7eb'} onChange={(e) => set('color', e.target.value)} className="h-8 w-12 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer" />
          ...
          <div className="flex gap-2">
            {(['left', 'center', 'right'] as Align[]).map((a) => (
              <button
                key={a}
                onClick={() => set('align', a)}
                className={`flex-1 py-1.5 text-xs rounded-lg border font-medium capitalize transition ${local.align === a ? 'bg-blue-600 text-white border-blue-600' : 'bg-white dark:bg-[#000c3b] text-gray-600 dark:text-slate-300 border-gray-200 dark:border-blue-950/40 hover:bg-gray-50 dark:hover:bg-gray-800'}`}
              >
                {a}
              </button>
            ))}
      ...
      {['h1', 'h2', 'text'].includes(block.type) && (
        <div>
          <label className={labelCls}>Color</label>
          <div className="flex items-center gap-2">
            <input type="color" value={local.color || '#374151'} onChange={(e) => set('color', e.target.value)} className="h-8 w-12 rounded border border-gray-200 dark:border-blue-950/40 cursor-pointer" />
      ...
      <div className="flex gap-2 pt-1">
        <button onClick={handleSave} className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary/90">
...
function SortableBlock({
  ...
  const Preview = () => {
    ...
    switch (type) {
      ...
      case 'divider':
        return <hr className="border-t border-gray-300 dark:border-blue-950/40 w-32" />;
      case 'spacer':
  ...
  return (
    <div ref={setNodeRef} style={style}>
      <div className={`group relative flex items-center gap-3 p-3 bg-white dark:bg-[#000c3b] rounded-xl border-2 transition-all ${isEditing ? 'border-blue-400 shadow-md' : 'border-gray-100 dark:border-blue-950/40 hover:border-gray-300 dark:hover:border-blue-950/40 hover:shadow-sm'}`}>
        {/* Drag handle */}
        <div
          {...attributes}
          {...listeners}
        ...
        {/* Type badge */}
        <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gray-50 dark:bg-[#000724] border border-gray-100 dark:border-blue-950/40 flex items-center justify-center text-gray-500">
          {typeIcon}
        </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {PALETTE.map(({ type, label, icon, desc }) => (
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 p-3 rounded-xl border border-gray-100 dark:border-blue-950/40 dark:bg-[#030a21]/60 hover:border-blue-300 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-all group"
                >
