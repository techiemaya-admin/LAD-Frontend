...
export default function ReviewCard({ proposal, reply, appliesOnNextGenerate, appliesOnNextConversation, applyAndUpdate, onApplied, onDiscard, noteDefault, onApply, applying = false, appliedVersion }: ReviewCardProps) {
  const { user } = useAuth();
