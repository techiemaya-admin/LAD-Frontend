...
export function getNodeIcon(type: StepType, size: string = 'w-5 h-5'): React.ReactNode {
  ...
  if (type === 'meeting_reminder') return <CalendarClock className={size} />;
