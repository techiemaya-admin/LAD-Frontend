...
interface RequirementsCollectionProps {
...
const FIELD_MAPPINGS: Record<string, { label: string; type: 'text' | 'url' | 'email' | 'phone' | 'textarea' | 'file' }> = {
...
export default function RequirementsCollection({
  ...
  const parseDocument = async (file: File): Promise<Record<string, any>> => {
  ...
  const generateExampleStructure = () => {
  ...
  const downloadExampleStructure = () => {
    const example = generateExampleStructure();
    ...
    <div className="w-full max-w-3xl mx-auto px-4 py-6 bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={downloadExampleStructure}
