...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      console.log('[Login] Login response received:', loginResponse);
      console.log('[Login] Token from response:', loginResponse.token);
      
      const user = await authService.getCurrentUser();
      console.log('[Login] User data fetched:', user);
      ...
      console.log('[Login] Token stored via safeStorage:', !!storedToken);
      console.log('[Login] Stored token value:', storedToken?.substring(0, 30) + '...');
