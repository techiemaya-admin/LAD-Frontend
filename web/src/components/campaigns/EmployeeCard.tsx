...
export default function EmployeeCard({
  ...
  return (
    <Card
      className={`
        flex-1 bg-white dark:bg-[#071131] rounded-xl border border-gray-200 dark:border-[#262831] shadow-sm
          ...
          >
            ...
            {(employee.title || employee.company) && (
              ...
              >
                ...
                {employee.company && (
                  <span className="line-clamp-1 break-words text-slate-500 dark:text-[#7a8ba3]">
                    {employee.company}
                  </span>
                )}
              </div>
