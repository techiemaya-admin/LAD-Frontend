...
const StatCard = ({ title, value, icon, bgColor, onClick }: StatCardProps) => (
  <div className="w-full sm:w-[calc(50%-8px)] md:w-[calc(25%-12px)]">
    <div
      className={`bg-white dark:bg-[#071131] rounded-[20px] border border-slate-200 dark:border-[#262831] shadow-sm w-full flex flex-col h-full min-h-[120px] transition-all ${onClick ? 'cursor-pointer hover:shadow-md hover:scale-[1.02] active:scale-[0.98]' : ''}`}
      onClick={onClick}
    >
      <div className="flex-1 flex flex-col p-4">
        <div className="flex flex-col h-full">
...
export default function CampaignStatsCards({ stats, loading = false }: CampaignStatsCardsProps) {
  ...
  return (
    <div className="flex gap-4 mb-6 flex-wrap items-stretch">
      ...
      >
        <div className="bg-white dark:bg-[#071131] rounded-[20px] border border-slate-200 dark:border-[#262831] shadow-sm w-full flex flex-col h-full min-h-[120px] transition-all hover:shadow-md hover:scale-[1.02] active:scale-[0.98]">
          <div className="flex-1 flex flex-col p-4">
            <div className="flex flex-col h-full">
              <div className="flex justify-end mb-2">
      ...
      {(() => {
        ...
        return (
          <div className="w-full sm:w-[calc(50%-8px)] md:w-[calc(25%-12px)]">
            <div
              className="bg-white dark:bg-[#071131] rounded-[20px] border border-slate-200 dark:border-[#262831] shadow-sm w-full flex flex-col h-full min-h-[120px] transition-all cursor-pointer hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
              onClick={() => router.push('/campaigns')}
            >
              <div className="flex-1 flex flex-col p-4">
                <div className="flex flex-col h-full">
