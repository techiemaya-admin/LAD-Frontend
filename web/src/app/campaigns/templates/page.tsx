        ...
        <div className="mb-5 flex flex-col sm:flex-row justify-between mt-10 items-stretch sm:items-center gap-2 sm:gap-0">
          ...
          {activeTab === 'email' ? (
            <button
              ...
              className="px-4 py-2 bg-[#0b1957] dark:bg-[#1a2a43] dark:border dark:border-[#262831] text-white rounded-xl hover:bg-[#0a1540] dark:hover:bg-[#253456] font-semibold shadow-[0_4px_20px_rgba(11,25,87,0.3)] hover:shadow-[0_8px_30px_rgba(11,25,87,0.5)] w-full sm:w-auto"
            >
              + Create Template
            </button>
          ) : (
            <button
              ...
              className="px-4 py-2 bg-[#0b1957] dark:bg-[#1a2a43] dark:border dark:border-[#262831] text-white rounded-xl hover:bg-[#0a1540] dark:hover:bg-[#253456] font-semibold shadow-[0_4px_20px_rgba(11,25,87,0.3)] hover:shadow-[0_8px_30px_rgba(11,25,87,0.5)] w-full sm:w-auto flex items-center gap-2"
            >
            ...
            {loading ? (
              ...
              <div className="bg-white dark:bg-[#1a2a43] border border-[#E2E8F0] dark:border-[#262831] rounded-xl p-12 text-center shadow-sm">
                <div className="w-16 h-16 rounded-full bg-[#0b1957]/5 dark:bg-[#253456] flex items-center justify-center mx-auto mb-4">
                  <FileText className="w-8 h-8 text-[#0b1957]/40 dark:text-white" />
                </div>
                <h3 className="text-lg font-bold text-[#1E293B] dark:text-white mb-2">No templates yet</h3>
                <p className="text-sm text-[#64748B] dark:text-[#7a8ba3] mb-6">Create your first email template to get started</p>
                <button
                  onClick={() => router.push('/campaigns/templates/create')}
                  className="px-5 py-2.5 bg-[#0b1957] dark:bg-[#1a2a43] dark:border dark:border-[#262831] text-white rounded-xl hover:bg-[#0a1540] dark:hover:bg-[#253456] font-semibold shadow-[0_4px_20px_rgba(11,25,87,0.3)] hover:shadow-[0_8px_30px_rgba(11,25,87,0.5)] transition-all"
                >
                  + Create Template
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {templates.map((template: any) => (
                  <div
                    key={template.id}
                    className="bg-white dark:bg-[#000724] border border-[#E2E8F0] dark:border-[#262831] rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden group"
                  >
                    ...
                    <div className="px-4 py-3">
                      ...
                      <p className="text-xs text-[#64748B] dark:text-[#7a8ba3] mt-0.5 line-clamp-1">
                    ...
                    <div className="px-4 py-2.5 border-t border-[#E2E8F0] dark:border-[#262831] bg-[#F8FAFC] dark:bg-[#000724] flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-1 text-xs font-semibold text-[#0b1957] dark:text-white hover:text-[#0a1540] dark:hover:text-[#7a8ba3] transition-colors"
                      >
        ...
        {activeTab === 'whatsapp' && (
          <div>
            ...
            {waLoading ? (
              ...
              <div className="bg-white dark:bg-[#1a2a43] border border-[#E2E8F0] dark:border-[#262831] rounded-xl p-12 text-center shadow-sm">
                <div className="w-16 h-16 rounded-full bg-[#0b1957]/5 dark:bg-[#253456] flex items-center justify-center mx-auto mb-4">
                  <MessageSquare className="w-8 h-8 text-[#0b1957]/40 dark:text-white" />
                </div>
                <h3 className="text-lg font-bold text-[#1E293B] dark:text-white mb-2">No WhatsApp templates yet</h3>
                <p className="text-sm text-[#64748B] dark:text-[#7a8ba3] mb-6">Create your first WhatsApp message template to get started</p>
                <button
                  onClick={() => router.push('/campaigns/templates/create/whatsapp')}
              ...
              <>
                ...
                <div className="flex justify-end mb-4">
                  <button
                    onClick={loadWaTemplates}
                    disabled={waLoading}
                    className="flex items-center gap-1.5 text-xs font-semibold text-[#64748B] dark:text-[#7a8ba3] hover:text-[#1E293B] dark:hover:text-white border border-[#E2E8F0] dark:border-[#262831] bg-white dark:bg-[#1a2a43] rounded-lg px-3 py-1.5 transition-colors"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {waTemplates.map((tpl) => {
                    ...
                    return (
                      <div
                        key={tpl.id || tpl.name}
                        className="bg-white dark:bg-[#1a2a43] border border-[#E2E8F0] dark:border-[#262831] rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden"
                      >
