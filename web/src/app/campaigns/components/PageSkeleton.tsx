  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        <div className="h-8 bg-gray-200 dark:bg-slate-800 rounded animate-pulse w-1/3"></div>
        <div className="h-4 bg-gray-200 dark:bg-slate-800 rounded animate-pulse w-2/3"></div>
      </div>
              ...
              <div className="flex-1 flex flex-col p-4">
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 flex flex-col justify-end">
                    <div className="h-4 bg-gray-200 dark:bg-slate-800 rounded animate-pulse mb-2 w-3/4"></div>
                    <div className="h-8 bg-gray-200 dark:bg-slate-800 rounded animate-pulse w-1/2"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="flex gap-4 items-center justify-between mb-6">
        <div className="flex gap-3">
          ...
          <div className="h-10 w-28 bg-gray-200 dark:bg-slate-800 rounded animate-pulse"></div>
          <div className="h-10 w-24 bg-gray-200 dark:bg-slate-800 rounded animate-pulse"></div>
        </div>
        <div className="h-10 w-36 bg-gray-200 dark:bg-slate-800 rounded animate-pulse"></div>
      </div>
          ...
          <div key={rowIndex} className="px-6 py-4 border-b border-gray-100">
            <div className="flex gap-4 items-center">
              {Array.from({ length: 6 }, (_, colIndex) => (
                <div 
                  key={colIndex} 
                  className={`h-4 bg-gray-200 dark:bg-slate-800 rounded animate-pulse flex-1 ${
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {Array.from({ length: 5 }, (_, index) => (
            <div key={index} className="h-10 w-10 bg-gray-200 dark:bg-slate-800 rounded animate-pulse"></div>
          ))}
        </div>
      </div>
    </div>
