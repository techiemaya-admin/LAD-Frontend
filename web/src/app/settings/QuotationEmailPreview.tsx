...
interface QuotationEmailPreviewProps {
  htmlContent: string;
  subject?: string;
      ...
      {showDeviceSelector && (
        <div className="flex gap-2 border-b border-gray-200 pb-3">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg transition ${device === 'mobile'
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg transition ${device === 'tablet'
                ? 'bg-blue-100 text-blue-700 border border-blue-300'
                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg transition ${device === 'desktop'
                ? 'bg-blue-100 text-blue-700 border border-blue-300'
                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
        ...
        <div className="flex flex-wrap gap-2">
          {placeholders.map((placeholder) => (
            <span key={placeholder.id} className="inline-block bg-white border border-blue-200 px-2 py-1 rounded text-xs text-blue-700 font-mono">
