...
const BACKEND_PATH = '/api/social-integration/email/microsoft/bookings/tenant-defaults';
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error('[/api/email/microsoft/bookings/tenant-defaults] POST Error:', e);
