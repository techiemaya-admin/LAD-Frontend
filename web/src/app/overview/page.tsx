...
const DashboardSkeleton: React.FC = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 auto-rows-min">
      ...
      <div className="md:col-span-4 h-36 rounded-xl bg-white p-4 shadow-sm">
        <div className="h-4 w-24 rounded bg-gray-200 animate-pulse" />
        <div className="mt-4 h-8 w-32 rounded bg-gray-200 animate-pulse" />
        <div className="mt-3 h-4 w-20 rounded bg-gray-200 animate-pulse" />
      </div>
      <div className="md:col-span-4 h-36 rounded-xl bg-white p-4 shadow-sm">
        <div className="h-4 w-28 rounded bg-gray-200 animate-pulse" />
        <div className="mt-4 h-8 w-36 rounded bg-gray-200 animate-pulse" />
        <div className="mt-3 h-4 w-24 rounded bg-gray-200 animate-pulse" />
      </div>
      <div className="md:col-span-4 h-36 rounded-xl bg-white p-4 shadow-sm">
        <div className="h-4 w-20 rounded bg-gray-200 animate-pulse" />
        <div className="mt-4 h-8 w-28 rounded bg-gray-200 animate-pulse" />
        <div className="mt-3 h-4 w-16 rounded bg-gray-200 animate-pulse" />
      </div>

      {/* Row 2: Calls Chart (w:6 h:4) + Voice Agents (w:6 h:4) */}
      <div className="md:col-span-6 h-80 rounded-xl bg-white p-4 shadow-sm">
        <div className="h-4 w-32 rounded bg-gray-200 animate-pulse" />
        <div className="mt-5 h-60 w-full rounded bg-gray-200 animate-pulse" />
      </div>
      <div className="md:col-span-6 h-80 rounded-xl bg-white p-4 shadow-sm">
        <div className="h-4 w-28 rounded bg-gray-200 animate-pulse" />
      ...
      <div className="md:col-span-6 h-80 rounded-xl bg-white p-4 shadow-sm">
        ...
        <div className="mt-4 h-24 rounded bg-gray-200 animate-pulse" />
      </div>
      <div className="md:col-span-6 h-80 rounded-xl bg-white p-4 shadow-sm">
        <div className="h-4 w-28 rounded bg-gray-200 animate-pulse" />
        <div className="mt-4 space-y-3">
          <div className="h-14 w-full rounded bg-gray-200 animate-pulse" />
          <div className="h-14 w-full rounded bg-gray-200 animate-pulse" />
          <div className="h-14 w-full rounded bg-gray-200 animate-pulse" />
          <div className="h-14 w-full rounded bg-gray-200 animate-pulse" />
        </div>
      ...
      <div className="md:col-span-12 h-96 rounded-xl bg-white p-4 shadow-sm">
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f0f6ff] via-[#f5f9ff] to-[#f0f6ff]">
      <main className="min-h-screen bg-white md:bg-gray-50 p-4 sm:p-6">
        <motion.div
