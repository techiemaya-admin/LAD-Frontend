...
# Media generation (LAD-MAGe). Empty means: use the playground worker (the pre-split layout).
ENV NEXT_PUBLIC_MEDIA_GEN_URL=${NEXT_PUBLIC_MEDIA_GEN_URL:-}
